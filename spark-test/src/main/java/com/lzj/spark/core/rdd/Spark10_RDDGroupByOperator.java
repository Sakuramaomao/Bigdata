 ...
 *       所以groupBy操作会导致数据不不均匀，产生shuffle。如果想改变不均匀，可以通过groupBy中加partitions参数来重新平衡数据。
 *
 * </pre>
 *
 * @Author zj.li
...
public class Spark10_RDDGroupByOperator {
    public static void main(String[] args) {
        ...
        // 分组后重新分区。
        JavaPairRDD<Integer, Iterable<Integer>> rdd1 = rdd.groupBy((Function<Integer, Integer>) v1 -> v1 % 2, 3);
